...
!function (e, t) {
    ...
    var F, L, I, j, q, B, W, Y, Z, K, $, G, J, Q, X,
        i = "ScrollSmoother",
        a = w(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        l = w(103, 115, 97, 112, 46, 99, 111, 109),
        c = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/,
        r = (function () {
            return true; // Always return true to disable the warning functionality
        })();

    ScrollSmoother.register = function register(e) {
        return L || (F = e || t(), s() && window.document && (I = window, j = document, q = j.documentElement, B = j.body), F && (W = F.utils.toArray, Y = F.utils.clamp, $ = F.parseEase("expo"), Q = F.core.context || function () { }, Z = F.core.globals().ScrollTrigger, F.core.globals("ScrollSmoother", ScrollSmoother), B && Z && (X = F.delayedCall(.2, function () { return Z.isRefreshing || K && K.refresh(); }).pause(), G = Z.core._getVelocityProp, J = Z.core._inputObserver, ScrollSmoother.refresh = Z.refresh, L = 1))), L;
    };
    ...
    ScrollSmoother = _createClass(ScrollSmoother, [{
        key: "progress",
        get: function get() {
    ...
    function ScrollSmoother(t) {
        ...
        function Za(t, e) {
            ...
            var r = isNaN(e.ratio) ? 1 : e.ratio, n = e.end - e.start, o = t - e.start, i = e.offset || 0, s = e.pins || [], a = s.offset || 0, l = e._startClamp && e.start <= 0 || e.pins && e.pins.offset ? 0 : e._endClamp && e.end === D() ? 1 : .5;
        ...
        function ab() {
            q = j.documentElement, B = j.body, Ra(), requestAnimationFrame(Ra), b && (Z.getAll().forEach(function (e) {
                ...
                var t = e._startClamp || e.start, r = e.autoSpeed ? Math.min(D(), e.end) : t + Math.abs((e.end - t) / e.ratio), n = r - e.end;
                if ((r -= n / 2) < (t -= n / 2)) {
                    var o = t;
                    t = r, r = o;
                }
        ...
        function fb(r, e, t, n, o) {
            function qc() {
                e = u(), t = parseFloat(d().value), i = parseFloat(e.value) || 1, a = "auto" === e.value, c = a || s && s._startClamp && s.start <= 0 || p.offset ? 0 : s && s._endClamp && s.end === D() ? 1 : .5, l && l.kill(), l = t && F.to(r, { ease: $, overwrite: !1, y: "+=0", duration: t }), s && (s.ratio = i, s.autoSpeed = a);
            }
            ...
            function uc(e) {
                if (a) {
                    ...
                    var t = function _autoDistance(e, t) {
                        var r, n, o = e.parentNode || q, i = e.getBoundingClientRect(), s = o.getBoundingClientRect(), a = s.top - i.top, l = s.bottom - i.bottom, c = (Math.abs(a) > Math.abs(l) ? a : l) / (1 - t), f = -c * t;
                        return 0 < c && (n = .5 == (r = s.height / (I.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, Math.abs(-c * r / (2 * r - 1))) * (t || 1), f += t ? -n * t : -n / 2, c += n), { change: c, offset: f };
            ...
            var i, s, a, l, c, f, u = eb("speed", e, n, r), d = eb("lag", t, n, r), h = F.getProperty(r, "y"), g = r._gsap, p = [], m = [], w = 0;
            return qc(), (1 !== i || a || l) && (uc(s = Z.create({
                ...
                onUpdate: function onUpdate(e) {
                    var t, r, n, o = h + w * (e.progress - c), i = p.length, s = 0;
                    if (e.offset) {
                        if (i) {
                            for (r = -H, n = e.end; i--;) {
        ...
        var n, v, e, i, b, s, a, l, c, f, r, u, d, h, g, p, m = t.smoothTouch, w = t.onUpdate, S = t.onStop, T = t.smooth, _ = t.onFocusIn, C = t.normalizeScroll, x = t.wholePixels, P = this, R = t.effectsPrefix || "", E = Z.getScrollFunc(I), k = 1 === Z.isTouch ? !0 === m ? .8 : parseFloat(m) || 0 : 0 === T || !1 === T ? 0 : parseFloat(T) || .8, A = k && +t.speed || 1, H = 0, M = 0, N = 1, U = G(0), z = { y: 0 }, O = "undefined" != typeof ResizeObserver && !1 !== t.autoResize && new ResizeObserver(function () {
            if (!Z.isRefreshing) {
                var e = D(v) * A;
        ...
        bb(), Z.addEventListener("killAll", bb), F.delayedCall(.5, function () {
            ...
            if (arguments.length) {
                ...
                return t !== n && (c = (n = t).getAttribute("style") || "", O && O.observe(n), F.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box", y: "+=0" }), k || F.set(n, { clearProps: "transform" })), this;
            }
            return n;
            ...
            }(n), l = v.getAttribute("style") || "", refreshHeight(), F.set(v, k ? { overflow: "hidden", position: "fixed", height: "100%", width: "100%", top: 0, left: 0, right: 0, bottom: 0 } : { overflow: "visible", position: "relative", width: "100%", height: "auto", top: "auto", bottom: "auto", left: "auto", right: "auto" }), this) : v;
            ...
            scrollTop: Va, scrollHeight: function scrollHeight() {
                return refreshHeight() && B.scrollHeight;
            }, fixedMarkers: !1 !== t.fixedMarkers && !!k, content: n, getBoundingClientRect: function getBoundingClientRect() {
        ...
        V.forEach(function (e) {
            ...
            }, id: "ScrollSmoother", scroller: I, invalidateOnRefresh: !0, start: 0, refreshPriority: -9999, end: function end() {
        ...
        }, i.getTween() && (i.getTween().vars.ease = t.ease || $), this.scrollTrigger = i, t.effects && this.effects(!0 === t.effects ? "[data-" + R + "speed], [data-" + R + "lag]" : t.effects, { effectsPadding: t.effectsPadding, refresh: !1 }), t.sections && this.sections(!0 === t.sections ? "[data-section]" : t.sections), V.forEach(function (e) {
            ...
            return arguments.length ? (!!f !== e && (e ? (i.getTween() && i.getTween().pause(), E(-H / A), U.reset(), (r = Z.normalizeScroll()) && r.disable(), (f = Z.observe({
                preventDefault: !0, type: "wheel,touch,scroll", debounce: !1, allowClicks: !0, onChangeY: function onChangeY() {
                    return Va(-H);
                }
            ...
            var r = Z.defaults({});
            r && r.scroller === v && Z.defaults({ scroller: I }), o.normalizer && Z.normalizeScroll(!1), clearInterval(a), K = null, O && O.disconnect(), B.style.removeProperty("height"), I.removeEventListener("focusin", Ya);
        }, this.refresh = function (e, t) {
            return i.refresh(e, t);
        }, C && (this.normalizer = Z.normalizeScroll(!0 === C ? { debounce: !0, content: !k && n } : C)), Z.config(t), "scrollBehavior" in I.getComputedStyle(B) && F.set([B, q], { scrollBehavior: "auto" }), I.addEventListener("focusin", Ya), a = setInterval(Pa, 250), "loading" === j.readyState || requestAnimationFrame(function () {
            return Z.refresh();
        });
    }
    ...
    r.version = "3.12.6", r.create = function (e) {
        ...
        return K;
    }, t() && F.registerPlugin(r), e.ScrollSmoother = r, e.default = r, Object.defineProperty(e, "__esModule", { value: !0 });
});